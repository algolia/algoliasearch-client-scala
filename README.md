...
1. [Search in indices - `multiQueries`](#search-in-indices---multiqueries)
...
1. [Delete index - `delete index`](#delete-index---delete-index)
1. [Clear index - `clear index`](#clear-index---clear-index)
...
1. [Get last logs - `logs`](#get-last-logs---logs)
1. [REST API](#rest-api)
...
## Search in indices - `multiQueries` 
